...
namespace ManagmentSystem.EF.Migrations
{
    ...
    [Migration("20250201095442_enhancForGeneratId")]
    partial class enhancForGeneratId
    {
            ...
            modelBuilder.Entity("ManagmentSystem.Core.Models.AccessListPrivilege", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "79cd0e60-626c-423b-88ea-d37b7016d299",
                            Code = 1f,
                            LastAccessed = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            UserPositionId = "1173961b-074b-4cb5-b85a-c363c30ddd77"
                        });
                });
            ...
            modelBuilder.Entity("ManagmentSystem.Core.Models.Department", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "ad49ccc1-36b6-4da8-ac27-4b05d28cd899",
            ...
            modelBuilder.Entity("ManagmentSystem.Core.Models.Position", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "fff01c6e-6013-4f48-b7fb-af2e8e148ece",
                            AName = "المدير العام",
                            DepartmentId = "ad49ccc1-36b6-4da8-ac27-4b05d28cd899",
            ...
            modelBuilder.Entity("ManagmentSystem.Core.Models.Privilege", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "fed35f2e-8398-42f8-b78b-b2223ccbf921",
            ...
            modelBuilder.Entity("ManagmentSystem.Core.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "5db0a025-dd01-44c4-ad96-925c02b31968",
            ...
            modelBuilder.Entity("ManagmentSystem.Core.Models.RolePrivilege", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = "5db0a025-dd01-44c4-ad96-925c02b31968",
                            PrivilegeId = "fed35f2e-8398-42f8-b78b-b2223ccbf921",
                            AddedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Id = "55c29c0a-f802-4b75-928f-0a0c42adb08e",
                            LastAccessed = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        });
                });
            ...
            modelBuilder.Entity("ManagmentSystem.Core.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "fd9da150-2850-4c2b-a93c-4b0acc1c7719",
                            AFirstName = "مدير",
                            ALastName = "النظام",
                            BlockedType = "None",
                            EFirstName = "System",
                            ...
                            IsBlocked = 0ul,
                            LastAccessed = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Password = "AQAAAAEAACcQAAAAEOdOur1OsgOFYvRoY5j5WcA3rzd6ZYGT9wwgx2uNhu+g0pAUR0V4KUfhGXt51P0GKg==",
            ...
            modelBuilder.Entity("ManagmentSystem.Core.Models.UserPosition", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "1173961b-074b-4cb5-b85a-c363c30ddd77",
                            AddedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            EndDate = new DateTime(2026, 2, 1, 12, 54, 41, 454, DateTimeKind.Local).AddTicks(142),
                            IsActive = 1ul,
                            LastAccessed = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            PositionId = "fff01c6e-6013-4f48-b7fb-af2e8e148ece",
                            StartDate = new DateTime(2025, 2, 1, 12, 54, 41, 452, DateTimeKind.Local).AddTicks(7767),
                            Type = "HR",
                            UserId = "fd9da150-2850-4c2b-a93c-4b0acc1c7719",
                            UserName = "admin"
                        });
                });
            ...
            modelBuilder.Entity("ManagmentSystem.Core.Models.UserPositionRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "b1c1af20-a95f-4ce6-b79d-67fe411c4e16",
                            AddedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            LastAccessed = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            RoleId = "5db0a025-dd01-44c4-ad96-925c02b31968",
                            UserPositionId = "1173961b-074b-4cb5-b85a-c363c30ddd77"
